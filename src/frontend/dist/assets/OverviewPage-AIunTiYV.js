...
function WheelColumn({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center flex-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-semibold uppercase tracking-wider text-muted-foreground mb-1", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full h-[200px] overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: {
            background: "linear-gradient(to bottom, oklch(var(--card)), transparent)"
          }
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: {
            background: "linear-gradient(to top, oklch(var(--card)), transparent)"
          }
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          children: items.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              style: {
                ...
                color: i === selectedIndex ? "oklch(var(--foreground))" : "oklch(var(--muted-foreground))",
...
function WheelDatePicker({ value, onChange }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 px-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      WheelColumn,
      {
        label: "Day",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (o) => !o && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      style: {
        ...
        borderRadius: 24,
        boxShadow: "0 20px 60px oklch(var(--primary) / 0.18), inset 0 1px 2px rgba(255,255,255,0.1)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { className: "px-5 pt-5 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-foreground font-display font-bold text-lg", children: initialData ? "Edit Transaction" : "Add Transaction" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: TYPE_TABS.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: cn(
                  ...
                  form.type === tab.value ? "text-primary-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"
                ),
                style: {
                  background: form.type === tab.value ? `oklch(${tab.color})` : "transparent"
                },
                children: tab.label
              },
              tab.value
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 pb-5 space-y-4 overflow-y-auto max-h-[60vh]", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  ...
                  placeholder: "0.00",
                  value: form.amount || "",
                  onChange: (e) => field("amount", Number.parseFloat(e.target.value) || 0),
                  className: "pl-7 font-semibold text-base",
                  style: {
                    background: "oklch(var(--muted) / 0.5)",
                    borderColor: errors.amount ? "oklch(var(--destructive))" : "oklch(var(--border))"
                  }
                }
              )
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Date" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
          ...
          form.type !== "transfer" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    SelectTrigger,
                    {
                      ...
                      style: {
                        background: "oklch(var(--muted) / 0.5)",
                        borderColor: errors.category ? "oklch(var(--destructive))" : "oklch(var(--border))"
                      },
          ...
          form.type !== "transfer" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Account" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    SelectTrigger,
                    {
                      ...
                      style: {
                        background: "oklch(var(--muted) / 0.5)",
                        borderColor: errors.accountId ? "oklch(var(--destructive))" : "oklch(var(--border))"
                      },
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select account" })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: accounts.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: a.id, children: a.name }, a.id)) })
                ]
              }
            ),
            errors.accountId && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "From" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      SelectTrigger,
                      {
                        ...
                        style: {
                          background: "oklch(var(--muted) / 0.5)",
                          borderColor: errors.fromAccountId ? "oklch(var(--destructive))" : "oklch(var(--border))"
                        },
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "From" })
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: accounts.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: a.id, children: a.name }, a.id)) })
                  ]
              ...
              errors.fromAccountId && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: errors.fromAccountId })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "To" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      SelectTrigger,
                      {
                        ...
                        style: {
                          background: "oklch(var(--muted) / 0.5)",
                          borderColor: errors.toAccountId ? "oklch(var(--destructive))" : "oklch(var(--border))"
                        },
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "To" })
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: accounts.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: a.id, children: a.name }, a.id)) })
                  ]
              ...
              errors.toAccountId && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: errors.toAccountId })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Note" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Description" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Textarea,
              {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  style: {
                    background: `oklch(${activeType == null ? void 0 : activeType.color})`,
                    color: "oklch(var(--primary-foreground))"
                  },
                  children: initialData ? "Save Changes" : "Add Transaction"
                }
              )
            ]
          }
...
function CircularProgressRing({
  ...
  const strokeDashoffset = animated ? circumference - percent / 100 * circumference : circumference;
  reactExports.useEffect(() => {
    const t = setTimeout(() => setAnimated(true), 100);
    return () => clearTimeout(t);
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 px-4 pt-3 pb-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base font-bold text-foreground leading-none", children: formatNaira(value) })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5 min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-base font-bold text-foreground tracking-tight leading-tight", children: "Safe to Spend" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Updated just now" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 mt-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-muted-foreground font-semibold uppercase tracking-widest", children: "Inflow" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-muted-foreground font-semibold uppercase tracking-widest", children: "Outflow" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-muted-foreground font-semibold uppercase tracking-widest", children: "Saved" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: "text-xs font-bold",
              style: { color: "oklch(var(--accent))" },
              children: formatNaira(75e3)
            }
          )
        ] })
      ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: fillStr, fill: `url(#${gradId})` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "polyline",
          {
            points: pointsStr,
...
function BalanceCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card glow-inner flex-1 p-4 flex flex-col gap-0.5 overflow-hidden relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10 text-[11px] text-muted-foreground font-semibold uppercase tracking-widest text-center", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10 text-xl font-black text-foreground leading-tight text-center", children: formatNaira(value) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex items-center justify-center gap-1 mt-0.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 12, style: { color } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-semibold", style: { color }, children: delta }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground", children: deltaLabel })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 z-0 opacity-60", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SparkLine, { data: sparkData, color }) })
  ] });
}
...
function TransactionRow({ tx, index: index2 }) {
  const amountColor = tx.transactionType === "credit" ? "oklch(var(--accent))" : "oklch(var(--destructive))";
  const catColor = CATEGORY_COLORS[tx.category] ?? "oklch(var(--muted-foreground))";
  const iconBg = tx.transactionType === "credit" ? "oklch(var(--accent) / 0.12)" : "oklch(var(--destructive) / 0.10)";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      "data-ocid": `activity.item.${index2 + 1}`,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end gap-0.5 flex-shrink-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: tx.date.slice(5) })
        ] })
      ]
    }
  );
...
function getPeriodData(mode, transactions) {
  let filtered = [];
  if (mode === "Daily") {
  ...
  const spent = filtered.filter((t) => t.transactionType === "debit").reduce((s, t) => s + t.amount, 0);
  const received = filtered.filter((t) => t.transactionType === "credit").reduce((s, t) => s + t.amount, 0);
...
function PeriodDetailPanel({
  ...
  const periodLabel = mode === "Daily" ? "Today" : mode === "Weekly" ? "This Week" : mode === "Monthly" ? "This Month" : "This Year";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex divide-x px-1 py-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center gap-0.5 px-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[9px] text-muted-foreground font-semibold uppercase tracking-widest", children: [
            "Received · ",
            periodLabel
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center gap-0.5 px-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-muted-foreground font-semibold uppercase tracking-widest", children: "Net" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
              className: "text-sm font-bold",
              style: {
                color: received - spent >= 0 ? "oklch(var(--accent))" : "oklch(var(--destructive))"
              },
              children: [
                received - spent >= 0 ? "+" : "−",
...
function OverviewPage() {
  const [viewMode, setViewMode] = reactExports.useState("Monthly");
  const [fabOpen, setFabOpen] = reactExports.useState(false);
  const modes = ["Daily", "Weekly", "Monthly", "Annual"];
  const {
    safeToSpend,
    safeToSpendPercent,
    startingBalance,
      ...
      children: [
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  "aria-hidden": "true",
                  style: {
                    background: "radial-gradient(ellipse 60% 60% at 50% 100%, oklch(var(--accent) / 0.07) 0%, transparent 70%)"
                  }
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: { background: "oklch(var(--muted))" },
            children: modes.map((mode) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                style: {
                  background: viewMode === mode ? "oklch(var(--primary))" : "transparent",
                  color: viewMode === mode ? "oklch(var(--primary-foreground))" : "oklch(var(--muted-foreground))",
                  boxShadow: viewMode === mode ? "0 2px 10px oklch(var(--primary) / 0.35)" : "none"
                },
                children: mode
              },
              mode
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(PeriodDetailPanel, { mode: viewMode, transactions }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", "data-ocid": "overview.balance_section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            BalanceCard,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "overview.activity_section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-bold text-foreground", children: "Recent Activity" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                to: "/transactions",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground flex-1", children: [
                  recentTxs.length,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: recentTxs.map((tx, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(TransactionRow, { tx, index: i }, tx.id))
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            style: {
              bottom: "80px",
              background: "linear-gradient(135deg, oklch(var(--primary)), oklch(0.42 0.16 265))",
              color: "oklch(var(--primary-foreground))",
              boxShadow: "0 4px 24px oklch(var(--primary) / 0.5), 0 0 0 3px oklch(var(--primary) / 0.15)"
            },
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 24, strokeWidth: 2.5 })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          TransactionForm,
