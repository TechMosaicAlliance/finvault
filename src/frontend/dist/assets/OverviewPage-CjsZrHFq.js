import { c as createLucideIcon, j as jsxRuntimeExports, r as reactExports, R as React, a as reactDomExports, b as ReactDOM, m as mockData, f as formatNaira } from "./index-DPcbY0g3.js";
import { S as Slot$1, c as cn, a as cva, b as composeRefs, u as useComposedRefs, X, P as Plus, L as Label, I as Input, B as Button } from "./label-CrnIurBM.js";
...
function CircularProgressRing({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center pt-6 pb-4 px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { width: size, height: size }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl font-bold text-foreground leading-none", children: formatNaira(value) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground mt-1.5 font-medium", children: "Safe to Spend" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-foreground mt-1 tracking-tight", children: "Safe to Spend Today" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Updated just now" })
  ] });
}
...
function BalanceCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card glow-inner flex-1 p-4 flex flex-col gap-0.5 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground font-semibold uppercase tracking-widest", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold text-foreground leading-tight", children: formatNaira(value) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 mt-0.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { size: 12, style: { color } }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SparkLine, { data: sparkData, color })
  ] });
}
...
function AddTransactionModal({
  ...
  const [category, setCategory] = reactExports.useState("Feeding");
  const [type, setType] = reactExports.useState("debit");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (v) => !v && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    DialogContent,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { className: "mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-lg font-bold text-foreground", children: "Add Transaction" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "flex flex-col gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: ["debit", "credit"].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  ...
                  style: {
                    background: type === t ? t === "credit" ? "oklch(var(--accent) / 0.2)" : "oklch(var(--destructive) / 0.2)" : "transparent",
                    color: type === t ? t === "credit" ? "oklch(var(--accent))" : "oklch(var(--destructive))" : "oklch(var(--muted-foreground))",
                    border: type === t ? `1px solid ${t === "credit" ? "oklch(var(--accent) / 0.4)" : "oklch(var(--destructive) / 0.4)"}` : "1px solid transparent"
                  },
                  children: t === "credit" ? "↑ Income" : "↓ Expense"
                },
                t
              ))
            }
...
function OverviewPage() {
  ...
  const modes = ["Daily", "Monthly", "Annual"];
  const {
    safeToSpend,
    safeToSpendPercent,
    startingBalance,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-5 pb-28", "data-ocid": "overview.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center py-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground font-semibold uppercase tracking-widest", children: "Inflow" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center py-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground font-semibold uppercase tracking-widest", children: "Outflow" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center py-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground font-semibold uppercase tracking-widest", children: "Saved" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: "text-sm font-bold",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AddTransactionModal, { open: fabOpen, onClose: () => setFabOpen(false) })
  ] });
}
export {
